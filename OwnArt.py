...
uploaded_content_pic = st.sidebar.file_uploader("Choose a content picture to Artify ")
uploaded_style_pic = st.sidebar.file_uploader("Choose an artistic picture (style)")
...
if uploaded_content_pic is not None and uploaded_style_pic is not None: 
